...
**[English](mysql-saturation.md)** | 繁體中文
...
| 來源 | 說明 |
|---|---|
| 完整性檢查全表掃描 | `tools/check-db-integrity.sh` 設 `WINDOW=0` 會掃全表（2026-09-06 為 59,557,108 筆）|
...
- [ ] orders 表已達 **59,557,108 筆**（2026-09-06 實查），評估索引與分區
