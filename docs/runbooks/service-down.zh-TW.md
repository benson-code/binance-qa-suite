...
| 進程在、CPU 滿載 | [gc-death-spiral](gc-death-spiral.zh-TW.md) |
| 進程在、CPU 閒置、port 沒開 | 應用啟動失敗，看 journal |
| 進程在、port 開、但不回應 | [gc-death-spiral](gc-death-spiral.zh-TW.md) 或執行緒池耗盡 |
| 主機整台失聯 | [host-down](host-down.zh-TW.md) |
