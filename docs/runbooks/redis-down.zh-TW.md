...
| 症狀 | 原因 |
|---|---|
| journal 有 OOM killer 訊息 | 主機記憶體不足，Redis 被殺 → [redis-unbounded](redis-unbounded.zh-TW.md) |
| `MISCONF` 錯誤 | RDB 快照寫入失敗（磁碟滿）→ [disk-capacity](disk-capacity.zh-TW.md) |
