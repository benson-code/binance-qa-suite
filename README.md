...
- **Observability built from real incidents** — 37 Prometheus alert rules whose thresholds are reverse-engineered from two measured production incidents · 15 runbooks with CI-enforced coverage · Alertmanager routing with four inhibition rules · one-command incident-scene preservation.
...
15 runbooks cover all 37 alerts. Each follows the same six sections: trigger
